...
This workshop aims to teach Digital Humanities and Library and Information Science students the basics of transcribing and annotating texts by using TEI-XML – a set of tags developed by the [Text Encoding Initative](https://www.tei-c.org) for the digitization of text-based documents with long-term preservation in mind. By doing so, it goes a long way towards serving the needs of Humanities scholars with a more qualitative approach to digital text analysis – to put it in the terms of our introductory session on [Text for Humans, and Text for Computers](before-the-workshop.html#text-for-humans-text-for-computers). 
...
<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vQinSeHBkwnRM46FXqVN3B0aqgy7nxG7H4mKnVYMvHKaGrH-Dd4k219eviEYN_SkWsaOEamHjB9Kh8V/pubembed?start=false&loop=false&delayms=3000" frameborder="0" width="960" height="569" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
</div>

While this lecture is usually taught live, it is based on [a lecture I recorded in 2022](#video) as part of a standalone MA course called 'Digitala Metoder' (Digital Research Methods) I co-taught at the [University of Borås](https://www.hb.se), and that I have used in various courses since. Autodidacts, or students looking for a quick refresher, can find and (re)watch that original [video](#video) below.
